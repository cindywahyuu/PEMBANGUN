...
<body>
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container-fluid">
            <a class="navbar-brand" href="#"><i class="fa-solid fa-building"></i></i> {{ $title }}</a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <b>PEMBANGUN (Pemantauan Bumi Bangunan)</b>
                    <br>
                    ...
                    yaitu pada isu "KIPK Tepat Sasaran".
                    <br>
                    <br>
                    Sumber Data: Bappelitbang Kota Bontang
                    <br>
                    <br>
